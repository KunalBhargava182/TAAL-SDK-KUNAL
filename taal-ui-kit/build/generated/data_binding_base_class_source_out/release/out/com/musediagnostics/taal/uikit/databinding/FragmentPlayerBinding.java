...
public final class FragmentPlayerBinding implements ViewBinding {
  ...
  private FragmentPlayerBinding(@NonNull ConstraintLayout rootView, @NonNull TextView actionText,
      ...
      @NonNull Button discardButton, @NonNull ImageButton playButton, @NonNull Button saveButton,
  ...
  public static FragmentPlayerBinding bind(@NonNull View rootView) {
    ...
    missingId: {
      ...
      return new FragmentPlayerBinding((ConstraintLayout) rootView, actionText, ampLabel, ampSlider,
          ampSliderContainer, backButton, discardButton, playButton, saveButton, saveDiscardBar,
          screenTitle, timerText, topBar, waveformChart);
    }
